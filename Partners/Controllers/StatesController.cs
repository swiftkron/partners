...
namespace Partners.Controllers
{
    public class StatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StateID,CountryID,Abbr,Name")] State state)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StateID,CountryID,Abbr,Name")] State state)
        {
            if (ModelState.IsValid)
            {
